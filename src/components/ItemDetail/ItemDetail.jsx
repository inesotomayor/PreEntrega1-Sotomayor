...
const ItemDetail = ({ producto }) => {
    ...
    const { formatoARS, anadirProductoCarrito } = useContext(CartContext)
    ...
    return (
        <div className="flex gap-10 p-12">
            ...
            <div>
                ...
                <h3 className="text-22px leading-none mb-4">{producto.nombre} ({producto.ano}) - {producto.formato}</h3>
