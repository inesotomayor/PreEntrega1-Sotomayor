...
const CarritoEnCheckout = () => {
    ...
    return (
        <div>
            <header className="grid gap-3 grid-cols-[50px_25%_60px_100px_auto] py-5 px-6 bg-primary text-white font-montserrat font-[600] text-10px tracking-wider uppercase">
                <div></div>
                <p>Producto</p>
            ...
            <ul>
                {carrito.map((producto) => (
                    <li key={producto.id} className="grid gap-3 grid-cols-[50px_25%_60px_100px_auto] border-b border-[#ccc] py-5 px-6">
